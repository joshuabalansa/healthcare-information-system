			...
			<ul id="main-menu" class="main-menu">
				...
				<li class="has-sub">
					...
					<ul>
						...
						<li>
							<a href="mailbox-compose.php">
								<i class="entypo-pencil"></i>
								<span class="title">Compose Message</span>
							</a>
						</li>
						<li>
							<a href="mailbox-message.php">
				...
				<li class="has-sub">
					...
					<ul>
						...
						<li>
							<a href="forms-file-upload.php">
								<span class="title">File Upload</span>
							</a>
						</li>
						<li>
							<a href="forms-wysiwyg.php">
					...
					<ul>
						<li class="has-sub">
							...
							<ul>
								...
								<li>
									<a href="extra-icons-entypo.php">
										<span class="title">Entypo</span>
									</a>
								</li>
								<li>
									<a href="extra-icons-glyphicons.php">
						...
						<li>
							<a href="extra-portlets.php">
								<span class="title">Portlets</span>
							</a>
						</li>
						<li class="has-sub">
							<a href="extra-google-maps.php">
						...
						<li>
							<a href="extra-calendar-2.php">
								<span class="title">Calendar 2</span>
								<span class="badge badge-secondary badge-roundless">New</span>
							</a>
						</li>
						<li>
							<a href="extra-notes.php">
						...
						<li>
							<a href="extra-register.php">
								<span class="title">Register</span>
							</a>
						</li>
						<li>
							<a href="extra-invoice.php">
								<span class="title">Invoice</span>
							</a>
						</li>
						<li class="has-sub">
							<a href="extra-gallery.php">
							...
							<ul>
								...
								<li>
									<a href="extra-gallery-single.php">
						...
						<li>
							<a href="extra-comments.php">
								<span class="title">Comments</span>
							</a>
						</li>
						<li>
							<a href="extra-timeline-centered.php">
								<span class="title">Timeline Centered</span>
							</a>
						</li>
						<li>
							<a href="extra-tocify.php">
						...
						<li>
							<a href="extra-new-post.php">
								<span class="title">New Post</span>
							</a>
						</li>
						<li>
							<a href="extra-settings.php">
								<span class="title">Settings</span>
							</a>
						</li>
						<li>
							<a href="extra-scrollbox.php">
								<span class="title">Scrollbox</span>
							</a>
						</li>
						<li>
							<a href="extra-image-crop.php">
								<span class="title">Image Crop</span>
							</a>
						</li>
						<li>
							<a href="extra-search.php">
								<span class="title">Search Page</span>
							</a>
						</li>
						<li>
							<a href="extra-language-selector.php">
								<span class="title">Language Selector</span>
							</a>
						</li>
						<li>
							<a href="extra-nestable.php">
								<span class="title">Nestable Lists</span>
							</a>
						</li>
						<li>
							<a href="extra-file-tree.php">
								<span class="title">File Tree</span>
							</a>
						</li>
						<li>
							<a href="extra-load-progress.php">
