...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	...
	<div class="main-content">
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="alert alert-default"><strong>Brother</strong> hundred he assured reached on up no. On am nearer missed lovers</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-12">
				<div class="alert alert-minimal"><strong>Doubtful</strong> disposed returned rejoiced to dashwood is so up.</div>
			</div>
