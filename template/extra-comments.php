	...
	<div class="main-content">
		...
		<section class="comments-env">
			...
			<div class="comment-filters">
				...
				<a href="#spam">Spam</a>
				<a href="#approval-waiting" class="current">Waiting Approval</a>
				...
				<div class="row">
					<div class="col-sm-3">
						...
						<select name="test" class="selectboxit">
							<optgroup label="Selected Comments">
					...
					<div class="col-sm-9 search-and-pagination">
							...
							<ul class="comments-list">
								...
								<li>
									...
									<div class="comment-details">
										...
										<div class="comment-head">
											<a href="#">Ksenia Sawicka</a> commented on <a href="#">The Women of the Flames</a>
										</div>
								...
								<li>
									...
									<div class="comment-details">
										...
										<div class="comment-head">
											<a href="#">Ralf Reiniger</a> commented on <a href="#">Forgotten Man</a>
										</div>
								...
								<li>
									...
									<div class="comment-details">
										...
										<div class="comment-head">
											<a href="#">Michaela Tomková</a> commented on <a href="#">The Growing Swords</a>
										</div>
			...
			<!-- Search and Comment Pagination (Footer) -->
			<div class="filtering">
			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="col-sm-2">
						...
						<br />
						<span>Comments: 1026</span>
						<br />
						<span>Member since: 2007</span>
					</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="field-3" value="Ksenia Sawicka">
								</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="form-group">
									...
									<textarea class="form-control" id="field-2" style="min-height: 120px;">Servants contempt as although addition dashwood is procured. Interest in yourself an do of numerous feelings cheerful confined.
...
Put use set uncommonly announcing and travelling. Allowance sweetness direction to as necessary. Principle oh explained excellent do my suspected conveying in. Excellent you did therefore perfectly supposing described.
						...
						<div class="row">
							<div class="col-md-4">
								...
								<div class="form-group">
									<label for="field-1" class="control-label">Date Added</label>

									<p>
										<strong>Tuesday, 20 March - 20:05</strong>
									</p>
								</div>
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									<label for="field-1" class="control-label">Article</label>

									<p>
										<a href="#">
											<strong>The Women of the Flames</strong>
										</a>
									</p>
								</div>
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									<label for="field-1" class="control-label">Comment Actions</label>

									<p>
										<a href="#" class="text-success bold">
											<i class="entypo-check"></i>
											Approve
										</a>
