...
<head>
	...
	<title>Neon | Right Sidebar Collapsed</title>
...
<div class="page-container sidebar-collapsed right-sidebar"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
