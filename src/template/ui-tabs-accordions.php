...
<head>
	...
	<title>Neon | Tabs &amp; Accordions</title>
		...
		<div class="row">
			...
			<div class="col-md-6">
				...
				<div class="tabs-vertical-env">
					...
					<ul class="nav tabs-vertical"><!-- available classes "right-aligned" -->
						<li class="active"><a href="#v-home" data-toggle="tab">Home</a></li>
			...
			<div class="col-md-6">
				...
				<div class="tabs-vertical-env">
					...
					<ul class="nav tabs-vertical right-aligned"><!-- available classes "right-aligned" -->
						<li class="active"><a href="#v-home" data-toggle="tab">Home</a></li>
						<li><a href="#v2-profile" data-toggle="tab">Profile</a></li>
						<li><a href="#v2-messages" data-toggle="tab">Messages</a></li>
						<li><a href="#v2-settings" data-toggle="tab">Settings</a></li>
					</ul>
