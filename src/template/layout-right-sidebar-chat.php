...
<head>
	...
	<title>Neon | Right Sidebar + Chat Visible</title>
...
<div class="page-container chat-visible sidebar-collapsed right-sidebar"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
